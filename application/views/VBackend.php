...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="temp/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SPP</b>SI</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php ('temp/dist/img/user2-160x160.jpg" class="img-circle'); ?>" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo site_url('Welcome/DataKelas'); ?>"><i class="fa fa-book"></i> <span>Kelas</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataPb'); ?>"><i class="fa fa-book"></i> <span>Transaksi Pembayaran</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataPt'); ?>"><i class="fa fa-book"></i> <span>Petugas</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataSiswa'); ?>"><i class="fa fa-book"></i> <span>Siswa</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataSPP'); ?>"><i class="fa fa-book"></i> <span>SPP</span></a></li>

        <li class="header">LABELS</li>
        <li><a href="<?php echo site_url('Welcome/Logout'); ?>"></a><i class="fa fa-circle-o text-red"></i> <span>Logout</span></a></li>
      </ul>
