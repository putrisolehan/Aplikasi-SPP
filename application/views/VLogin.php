...
<div class="login-box">
  <div class="login-logo">
    <a href="temp/index2.html"><b>SPP</b><br>Sistem Informasi</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="" method="post">
        ...
        <input type="text" name="id_login" class="form-control" placeholder="ID Login">
      ...
      <div class="form-group has-feedback">
       ...
       <div class="form-group has-feedback">
        <select name="level" class="form-control" placeholder="Status"> <option>Admin</option><option>Petugas</option><option>Siswa</option></select>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="row">
        <div class="col-xs-8">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <input type="submit" class="btn btn-primary btn-block btn-flat" name="btn_login" value="Login" >
        </div>
        <!-- /.col -->
      </div>
    </form>
